...
public class Main {
    public static void main(String[] args) {
        ...
        family.memberSetFather(family.getMember("Наталья Сергеевна"),
                family.getMember("Сергей Петрович"));
        ...
        Human tda = new Human("Дмитрий Андреевич",
                family.getMember("Наталья Сергеевна"), andr);
        family.addMember(tda);

        family.addMember(new Human("Мария"));

        Human tsd = new Human("София Дмитриевна",
                tda, family.getMember("Мария"));
        ...
        Cat mark = new Cat("Mark", "Bengal",
                family.getMember("Мария"));
